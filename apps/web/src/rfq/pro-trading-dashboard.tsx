                ...
                <div className="tx-success-banner">
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "0.7rem", color: "var(--text-secondary)" }}>
                      Flare Tx: <a href="https://coston2-explorer.flare.network/address/0x5bdfb417953fd1f87383dc07b8677a5b9cc880ab" target="_blank" rel="noopener noreferrer" style={{ color: "var(--brand-emerald)", textDecoration: "underline" }}>{submittedTx.slice(0, 14)}... ↗</a> · Sealed with Flare TEE Master Key
                    </div>
                  </div>
                </div>
              )}
